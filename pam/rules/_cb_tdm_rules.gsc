...
{
    // Hostname and MOTD 
	setcvar("sv_hostname" , "ClanBase Match in Progress"); 
	setcvar("scr_motd" , "ClanBase Ladder Match - www.clanbase.com");

	// Logo
	game["leaguestring"] = &"ClanBase Match Mode";  //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH

	/* Match Setup Options */
    maps\mp\uox\_uox_vars::updateCvar("scr","score_rounds", "0", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","warmup", "2", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","halftime", "1", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","overtime", "0", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","teamscorepenalty", "1", "tdm");

	// TDM Settings .
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "2", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "15", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "7", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "2", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","roundreset", "1", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","scorelimit", "0", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_scorelimit", "0", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","timelimit", "0", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","countdraws", "1", "tdm");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr", "forcerespawn", "3", "tdm");

    maps\mp\uox\_uox_vars::updateCvar("sv","showEndRoundScoreboard", true, "tdm");
    maps\mp\uox\_uox_vars::updateCvar("sv","showScoreboard", false, "tdm");
    maps\mp\uox\_uox_vars::updateCvar("sv","showScoreboardScorelimit", false, "tdm");
    maps\mp\uox\_uox_vars::updateCvar("sv","showPlayersLeft", false, "tdm");

	// Team Icons 
    maps\mp\uox\_uox_vars::updateCvar("scr", "drawfriend", "1", "tdm");
	// Friendly Fire 
	maps\mp\uox\_uox_vars::updateCvar("scr", "friendlyfire", "1", "tdm");
	// Kill Cam & Spectate
    maps\mp\uox\_uox_vars::updateCvar("scr", "killcam", "0", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr", "final_killcam", "0", "tdm");

    // Auto Team Balance
    maps\mp\uox\_uox_vars::updateCvar("scr", "teambalance", "0", "tdm");
    //spectate Settings
	...
	// Health Drop 
	maps\mp\uox\_uox_vars::updateCvar("scr","drophealth" , "1", "tdm");
	...
	// Timers
	setcvar("scr_strat_time", "5");	// round warmup time

	// Score Settings
	setcvar("scr_tdm_clearscoreeachhalf", "1");	// Re-set Players Score at halftime? 1=Yes 0=No  Used to reset battlerank if it is on.
	...
	setcvar("scr_vehicle_limit_jeep", "50"); // Limits the number of jeeps available on the map at any given time (0 = disabled)
