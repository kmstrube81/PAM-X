...
{
    // Hostname and MOTD 
	setcvar("sv_hostname" , "NA COMP Scrim Server"); 
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","overtime", "1");
	
	// *****************************************************
	// *********** Stock Match Config Cvars ****************
	// *****************************************************
    maps\mp\uox\_uox_vars::updateCvar("scr","teamscorepenalty", "1");
    ...
    //After Action Report
    maps\mp\uox\_uox_vars::updateCvar("pam","afteractionreport" , false);
    ...
    switch(getCvar("g_gametype"))
    {
        ...
        case "tdm":
            ...
            maps\mp\uox\_uox_vars::updateCvar("scr", "ot_roundlength", "0", "tdm");
        ...
        case "sd":
            ...
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "1.75", "sd");
        ...
        case "re":
            ...
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_scorelimit", "0", "re");
            maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "20", "re");
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "6", "re");
            maps\mp\uox\_uox_vars::updateCvar("scr","score_rounds", "1", "re");
            maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "2.5", "re");
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "2.5", "re");
        ...
        case "dom":
            ...
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "1", "dom");
            maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "0", "dom");
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "0", "dom");
        ...
        case "ctf":
            ...
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "1", "ctf");
            maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "15", "ctf");
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "0", "ctf");
        ...
        case "hq":
            ...
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_scorelimit", maps\mp\uox\_uox::getTeam1Score() + 1, "hq");
            maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "2", "hq");
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "1", "hq");
            maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "10", "hq");
            maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "0", "hq");
	...
	// Timers
	maps\mp\uox\_uox_vars::updateCvar("scr", "strattime", "5");	// round warmup time
