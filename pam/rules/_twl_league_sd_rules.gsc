...
{
    // Hostname and MOTD 
	setcvar("sv_hostname" , "^1TWL ^7S&D ^3League Match"); 
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "24", "sd");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","countdraws", "1", "sd");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","graceperiod", "5", "sd");
    ...
    maps\mp\uox\_uox_vars::updateCvar("sv","showPlayersLeft", true, "sd");
