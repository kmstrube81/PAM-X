Rules()
{
	...
	setcvar("scr_motd" , "PAMUO v3.1 TWL- Match Mode v1.2"); 

	// Logo
	game["leaguestring"] = &"TWL- Match Mode v1.2"; //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","overtime", "1", "tdm");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "1", "tdm");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "15", "tdm");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_scorelimit", maps\mp\uox\_uox::getTeam1Score() + 15, "tdm");
	...
	// Timers
	setcvar("scr_sd_strattime", "5");	// round warmup time
