Rules()
{
	...
	setcvar("scr_motd" , "BritLeague Classic Match - www.britleague.com");

	//Logo
	game["leaguestring"] = &"BritLeague Classic Match Mode";  //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
   ...
   //SD VARS
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "14", "sd");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlimit", "14", "sd");
    maps\mp\uox\_uox_vars::updateCvar("scr","score_rounds", "0", "sd");
    maps\mp\uox\_uox_vars::updateCvar("scr","scorelimit", "11", "sd");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_scorelimit", "14", "sd");
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "5", "sd");
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "5", "sd");
	...
	// *****************************************************
	// OT settings
	//setCvar("scr_randomsides", "0");	// Choose Random Sides for us if we need OT - Not implemented in CODUOX yet

	// Timers
	setcvar("scr_sd_strattime", "5");	// round strat time  -- Not implemented in CODUOX yet

	// Score Settings
	setcvar("scr_sd_clearscoreathalf", "1");	// Re-set Players Score at halftime? 1=Yes 0=No  Used to reset battlerank if it is on. -- not implemented yet
