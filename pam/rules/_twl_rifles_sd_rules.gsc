Rules()
{
	...
	setcvar("scr_motd" , "PAMUO v3.1 TWL-Rifles Match Mode v1.2"); 

	//Logo
	game["leaguestring"] = &"TWL-Rifles Match Mode v1.2"; //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_scorelimit", maps\mp\uox\_uox::getTeam1Score() + 1, "sd");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","graceperiod", "3", "sd");
	...
	// Health Drop 
	maps\mp\uox\_uox_vars::updateCvar("scr","drophealth" , "1", "sd");
	...
	// Bomb Settings
	maps\mp\uox\_uox_vars::updateCvar("scr", "bombplanttime", "5", "sd");
	...
	//setcvar("sv_alliedSniperLimit", "0");	// allied sniper limit
	//setcvar("sv_axisSniperLimit", "0");	// axis sniper limit
	...
	// MGs
	//setcvar("sv_alliedMGLimit", "0");	// allied mg limit
	//setcvar("sv_axisMGLimit", "0");	// axis mg limit
	...
	//SMGs
	//setcvar("sv_alliedSMGLimit", "0");	// allied smg limit
	//setcvar("sv_axisSMGLimit", "0");	// axis smg limit
