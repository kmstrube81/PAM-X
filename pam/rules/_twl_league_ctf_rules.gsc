...
{
    // Hostname and MOTD 
	setcvar("sv_hostname" , "^1TWL ^7CTF ^3Standard League Match"); 
	setcvar("scr_motd" , "PAMUO v3.1 TWL-League Match Mode v1.2"); 

	// Logo
	game["leaguestring"] = &"TWL-League Match Mode v1.2";  //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","ot_roundlength", "20", "ctf");
    maps\mp\uox\_uox_vars::updateCvar("sv","endRoundScoreboardTime","15", "ctf");
    maps\mp\uox\_uox_vars::updateCvar("scr","roundreset", "1", "ctf");
    maps\mp\uox\_uox_vars::updateCvar("scr", "showoncompass", "0", "ctf");
    maps\mp\uox\_uox_vars::updateCvar("scr", "positionTime", "10", "ctf");
	...
	setcvar("scr_tank_respawn_wait" , "180");
	...
	setcvar("scr_artillery_first_interval" , "90"); // How long after spawn the Artillery Strike becomes available?
	setcvar("scr_artillery_interval" , "180"); // How long between artillery stikes
