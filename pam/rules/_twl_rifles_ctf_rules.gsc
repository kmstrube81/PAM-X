Rules()
{
	...
	setcvar("scr_motd" , "PAMUO v3.1 TWL-Rifles Only Match Mode v1.2"); 

	// Logo
	game["leaguestring"] = &"TWL-Rifles Only Match Mode v1.2";  //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
