...
{
    // Hostname and MOTD 
	setcvar("sv_hostname" , "KlanWars Match in Progress"); 
	setcvar("scr_motd" , "^3www^7.^1KlanWars^7.^3com"); 

	//Logo
	game["leaguestring"] = &"KlanWars-S&D Match Mode"; //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
	...
	setcvar("scr_sd_end_round" , "0");	// End Map AFTER this round.
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "21", "sd");
