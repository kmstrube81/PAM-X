Rules()
{
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","scorelimit", "20", "bas");
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlimit", "2", "bas");
    maps\mp\uox\_uox_vars::updateCvar("scr","roundlength", "20", "bas");
    ...
    maps\mp\uox\_uox_vars::updateCvar("sv","showEndRoundScoreboard", true, "bas");
    maps\mp\uox\_uox_vars::updateCvar("sv","showScoreboard", false, "bas");
    maps\mp\uox\_uox_vars::updateCvar("sv","showScoreboardScorelimit", false, "bas");
    maps\mp\uox\_uox_vars::updateCvar("sv","showPlayersLeft", false, "bas");

	// Respawn Timer
	setcvar("scr_bas_respawn_wave_time", "10");

	//  Start & End Round Timers
	maps\mp\uox\_uox_vars::updateCvar("sv","endRoundScoreboardTime","10", "bas");

	// Score Reset Each Round
	maps\mp\uox\_uox_vars::updateCvar("scr","roundreset", "1", "bas");
	...
	// *****************************************************
	// Timers
	setcvar("scr_bas_strattime", "5");	// round warmup time
