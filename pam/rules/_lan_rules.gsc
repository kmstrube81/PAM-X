...
{
    // Hostname and MOTD 
	setcvar("sv_hostname" , "PAM-X LAN"); 
	setcvar("scr_motd" , "PAM-X LAN"); 

	//Logo
	game["leaguestring"] = &"LAN Match Mode"; //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
    ...
    switch(getCvar("g_gametype"))
    {
        case "dm":
            ...
            maps\mp\uox\_uox_vars::varDef("scr", "spawnpoints", "dm", "dm");
            maps\mp\uox\_uox_vars::varDef("scr", "reinforcements", "-1", "dm");
            break;
        case "tdm":
