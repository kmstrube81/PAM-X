...
{
    // Hostname and MOTD 
	//setcvar("sv_hostname" , "GameArena Match in Progress"); 
	setcvar("scr_motd" , "^3www^7.^1GameArena^7.^3com^7.^1au");

	// Logo
	game["leaguestring"] = &"GameArena - Match Mode";  //NOTE!!! NEVER REMOVE THE & SYMBOL OR SERVER WILL CRASH
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr","overtime", "0", "ctf");
    ...
    maps\mp\uox\_uox_vars::updateCvar("sv","endRoundScoreboardTime","5", "ctf");
    ...
    maps\mp\uox\_uox_vars::updateCvar("scr", "spawn_delay_time", "20", "ctf");
    //CTF VARS 
	...
	maps\mp\uox\_uox_vars::updateCvar("scr","rank_ppr" , "15"); //Sets the Points Per Rank
	...
	setcvar("scr_rank_ppr" , "15"); //Sets the Points Per Rank
	...
	setcvar("g_vehicleBurnTime" , "20"); // Time in seconds a vehicle burns before blowing up
	...
	setcvar("scr_jeep_spawn_limit", "3"); // 0 is disabled. Each vehicle will only spawn this number of times
	setcvar("scr_vehicle_limit_jeep", "2"); // Limits the number of jeeps available on the map at any given time (0 = disabled)

	setcvar("scr_allow_horch" , "1");
	setcvar("scr_allow_gaz67b" , "1"); 
	setcvar("scr_allow_willyjeep" , "1");

	setcvar("scr_jeep_respawn_wait" , "45");
	...
	setcvar("scr_tank_spawn_limit", "3"); // 0 is disabled. Each vehicle will only spawn this number of times
	setcvar("scr_vehicle_limit_medium_tank", "2"); // Limits the number of medium tanks available on the map at any given time (0 = disabled)
	setcvar("scr_vehicle_limit_heavy_tank", "1"); // Limits the number of heavy tanks available on the map at any given time (0 = disabled)
	...
	setcvar("scr_tank_respawn_wait" , "90");
